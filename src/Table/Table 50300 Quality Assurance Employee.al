table 50300 "Quality Assurance Employee"
{
    //T51170-N
    Description = 'T51170';
    Caption = 'Quality Assurance Employee';
    LookupPageID = "Quality Assurance Employee";
    ReplicateData = true;
    ...
    var
        WhseEmployee: Record "Quality Assurance Employee";
        IsHandled: Boolean;
    begin
        IsHandled := false;
    ...
    local procedure OnBeforeCheckDefault(var QualityAssuranceEmployee: Record "Quality Assurance Employee"; var IsHandled: Boolean)
    begin
    end;
}
